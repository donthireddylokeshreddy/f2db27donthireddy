...
router.get('/', function (req, res) {
  res.render('index', { title: 'grocary App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'grocary App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'grocary App Login', user: req.user });
});
